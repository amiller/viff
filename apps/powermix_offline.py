...
class Protocol:
	...
	record_stop()
        ...
        # print lines
	filename = "precompute-butterfly-N%d-t%d-k%d-B%d-id%d.share" % (self.runtime.num_players, self.runtime.threshold, self.k, self.B, self.runtime.id)
...
pre_runtime.addCallback(Protocol, Zp, k=1024, B=1)
